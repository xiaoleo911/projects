				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						...
						<td width="auto" align="left">
							<div id="Search">
								<div style="width: 276px; height: 28px; background-size: 276px 28px; background-image: url('pic/search.png'); background-repeat: no-repeat; display: inline-block;">
									<input type="text" maxlength="40" name="q" id="q" value="" />
								</div>
							</div>
						</td>
						<td width="570" align="right" style="padding-top: 2px;">
							<a href="<%=request.getContextPath() %>/index" class="top">首页</a>&nbsp;&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/signup.jsp"
								class="top">注册
							</a>
							&nbsp;&nbsp;&nbsp;
							<a href="<%=request.getContextPath() %>/signin.jsp" class="top">登录</a>
						</td>
					</tr>
				</table>
			</div>
			...
			<div id="Rightbar">
				...
				<div class="box">
					...
					<div class="inner">
						<div class="sep5"></div>
						<div align="center">
							<a href="<%=request.getContextPath() %>/signup.jsp" class="super normal button">现在注册</a>
							<div class="sep5"></div>
							<div class="sep10"></div>
							已注册用户请 &nbsp;<a href="<%=request.getContextPath() %>/signin.jsp">登录</a>
						</div>
					</div>
				</div>
				<div class="sep20"></div>
